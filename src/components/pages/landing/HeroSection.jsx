...
export default function HeroSection() {
  return (
    <section className="relative pt-24 pb-32 overflow-hidden bg-linear-to-br from-indigo-50 via-purple-50 to-blue-50 dark:from-indigo-900/30 dark:via-purple-900/30 dark:to-blue-900/30">
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#4F46E51A] rounded-full blur-3xl"
        data-alt="A large, soft, circular gradient blur effect for decoration."
      ></div>

      <div className="absolute w-30 h-30 bg-[#4F46E51A] rounded-full top-60 left-25"></div>
      <div className="absolute w-25 h-25 bg-[#4F46E51A] rounded-full top-40 left-285"></div>
      <div className="absolute w-10 h-10 bg-[#4F46E51A] rounded-full top-30 left-55"></div>
        ...
        <div className="max-w-3xl mx-auto flex flex-col gap-6 text-center items-center justify-center pt-16">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="text-slate-600 dark:text-slate-400 text-lg font-normal leading-normal md:text-xl">
              Buy tickets for concerts, sports, and shows — your next
              unforgettable experience is one click away.
            </h2>
          </div>

          <Link href={"/signup"}>
            <div className="flex flex-wrap gap-4 justify-center  bg-[#4F46E5] rounded-full hover:scale-105 transition-transform">
      ...
      <div
        className="absolute -bottom-px left-0 right-0 w-full h-24 text-[#4F46E51A]"
